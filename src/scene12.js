                    ...
                    createMenu(this, {
                        ...
                        callbacks: [
                            () => {
                                ...
                                else if (this.game.globalState.crop == "cowpea") { this.game.globalState.biodiversity += 2 };
                    ...
                    createMenu(this, {
                        ...
                        callbacks: [
                            () => {
                                ...
                                this.game.globalState.neighborScore += 2;
                                this.scene.get('hud').updateStats();
                                this.scene.start("slots", { nextScene: "scene14", sourceScene: "scene12" });
                            ...
                            () => {
                                ...
                                this.game.globalState.neighborScore -= 2;
                                this.scene.get('hud').updateStats();
                                this.scene.start("planttiming", { nextScene: "scene14", sourceScene: "scene12" });
                            }
                        ]
                    })
                });
